...
## How to use:
- identify the few uncertainties that would most change the decision
- create scenarios that are meaningfully different, not best/base/worst labels only
- separate robust moves from bets that depend on a specific scenario

```text
Identify the uncertainties that would most change the decision.
