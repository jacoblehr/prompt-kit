...
```text
Apply jobs-to-be-done analysis to this product, feature, or user behaviour.
...
- stage: frame
- strength: medium
- pairs with: `mode.explore`, `frame.stakeholder-map`, `frame.task`
