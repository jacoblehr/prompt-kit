...
4. add a strategy, core, or lens block as needed
...
- snippets that substantially overlap with existing core blocks
- prompt helpers that were redundant with the core browse set
