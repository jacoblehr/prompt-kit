...
const STACK_META = {
  ...
  "assumption-inversion": { family: "Thinking & Framing", stage: "explore", outputKind: "options", stakes: "medium" },
  ...
  "counterfactual-roadmap": { family: "Deciding & Prioritising", stage: "decide", outputKind: "plan", stakes: "high" },
  ...
  "weird-prototype": { family: "Research & Analysis", stage: "frame", outputKind: "brief", stakes: "medium" },
  ...
  "negative-space-critique": { family: "Critique & Review", stage: "critique", outputKind: "critique", stakes: "medium" },
  ...
  "agentic-coding": { family: "Developer Workflows", stage: "decide", outputKind: "plan", stakes: "high" },
  "implement-change": { family: "Developer Workflows", stage: "decide", outputKind: "plan", stakes: "high" },
  "test-strategy": { family: "Developer Workflows", stage: "critique", outputKind: "plan", stakes: "high" },
  "refactor-plan": { family: "Developer Workflows", stage: "decide", outputKind: "plan", stakes: "high" },
  "api-contract-design": { family: "Developer Workflows", stage: "frame", outputKind: "brief", stakes: "high" },
